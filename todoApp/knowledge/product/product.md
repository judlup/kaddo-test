...
## MVP Decisions (Closed)

- **Projects:** Optional. Tasks can exist without a project.
- **Priority:** Included with three levels: `low`, `medium`, `high`.
- **Due dates:** Not included in MVP.
- **Completed tasks visibility:** Hidden by default in listings.
- **Delete behavior:** Soft delete using `deleted_at` timestamp (archive).
- **CLI output:** Plain text or simple table format. No JSON support in MVP.
